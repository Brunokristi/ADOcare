import {
  script as script12,
  script2 as script13
} from "./chunk-BYRO77TX.js";
import {
  script as script11
} from "./chunk-3MKUZSYM.js";
import "./chunk-5QL2UWX4.js";
import {
  script as script16
} from "./chunk-K3XX6CHW.js";
import {
  FocusTrap
} from "./chunk-6PUHM6XO.js";
import {
  script as script15
} from "./chunk-BBJ367FA.js";
import {
  script as script14
} from "./chunk-KELATBWN.js";
import {
  script as script4,
  script2 as script9,
  script3 as script10
} from "./chunk-MQ6HEVXZ.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus,
  _default,
  getVNodeProp
} from "./chunk-5NW6OTLY.js";
import "./chunk-YYP2X36L.js";
import "./chunk-BKZCKAY5.js";
import "./chunk-RGKMM3A6.js";
import {
  script as script3
} from "./chunk-DI6BCPD7.js";
import {
  script as script5
} from "./chunk-WKARKZZF.js";
import {
  script as script8
} from "./chunk-IW7ITGWE.js";
import {
  script as script6
} from "./chunk-O25VA7VP.js";
import {
  Ripple
} from "./chunk-HWDHAJD5.js";
import {
  script as script2
} from "./chunk-DR4S53AW.js";
import {
  script as script7
} from "./chunk-65JJD372.js";
import "./chunk-3LX3BLXE.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-H5SRFZGA.js";
import {
  script
} from "./chunk-WXRIUT5E.js";
import "./chunk-DAMENFZU.js";
import {
  BaseStyle
} from "./chunk-XGGHDCGY.js";
import {
  C,
  D,
  Dt,
...
function _slicedToArray2(r, e) {
  return _arrayWithHoles2(r) || _iterableToArrayLimit2(r, e) || _unsupportedIterableToArray17(r, e) || _nonIterableRest2();
}
...
var script34 = {
  ...
  data: function data12() {
    return {
      ...
      d_multiSortMeta: this.multiSortMeta ? _toConsumableArray16(this.multiSortMeta) : [],
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data13 = _toConsumableArray16(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray16(this.d_multiSortMeta));
        }
      }
      var data13 = _toConsumableArray16(value);
      data13.sort(function(data1, data22) {
    ...
    addMultiSortField: function addMultiSortField(field2) {
      ...
      this.d_multiSortMeta = _toConsumableArray16(this.d_multiSortMeta);
    },
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray16(_selection2), [rowData]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray16(this.selection), [rowData]) : [rowData];
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray16(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray16(_selection5), [rowData]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked2) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray16(this.frozenValue), _toConsumableArray16(this.processedData)) : this.processedData;
    ...
    generateCSV: function generateCSV(options, data13) {
      ...
      if (!data13) {
        ...
        else if (this.frozenValue) data13 = data13 ? [].concat(_toConsumableArray16(this.frozenValue), _toConsumableArray16(data13)) : this.frozenValue;
      }
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray16(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray16(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      ...
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray16(this.expandedRowGroups) : [];
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray16(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray16(this.editingRows);
  ...
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray16(cols.filter(function(item) {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray16(this.frozenValue), _toConsumableArray16(this.processedData)) : this.processedData;
