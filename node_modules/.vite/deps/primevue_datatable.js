import {
  script as script13
} from "./chunk-NN5EXQUC.js";
import {
  script as script8
} from "./chunk-MXZ25VLK.js";
import {
  script as script7
} from "./chunk-OKZCXW2S.js";
import {
  FocusTrap
} from "./chunk-Q3R3ZGEM.js";
import {
  script as script12
} from "./chunk-RY3ENYFR.js";
import {
  script as script6
} from "./chunk-EKXNBQRF.js";
import {
  script as script9,
  script2 as script10,
  script3 as script11
} from "./chunk-QMDQHW2N.js";
import {
  Ripple
} from "./chunk-5YR4XYKG.js";
import "./chunk-3LX3BLXE.js";
import {
  script as script14
} from "./chunk-5TFCFZMQ.js";
import {
  script as script5
} from "./chunk-5KYHTCC3.js";
import {
  script as script3
} from "./chunk-ULRSYPLC.js";
import {
  script as script4
} from "./chunk-KHQTXA2X.js";
import {
  script as script2
} from "./chunk-PLJATCNF.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-NNQX7FWH.js";
import {
  script
} from "./chunk-Y2LWWIDA.js";
import {
  $t,
  At,
  BaseStyle,
...
import {
  ...
  p,
  s as s2
} from "./chunk-S54RLHEN.js";
import {
  s
} from "./chunk-VJ5H7DUU.js";
import "./chunk-AJM4KOOG.js";
import {
  Fragment,
  Transition,
  createBaseVNode,
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty4({}, typeof _this17.optionGroupChildren === "string" ? _this17.optionGroupChildren : "items", _toConsumableArray8(filteredItems))));
          });
...
var _hoisted_14 = ["data-p-checked", "data-p-disabled", "data-p"];
var _hoisted_22 = ["id", "value", "name", "checked", "tabindex", "disabled", "readonly", "aria-labelledby", "aria-label", "aria-invalid"];
...
function render16(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "data-p": $options.dataP
  }), null, 16, _hoisted_42)], 16, _hoisted_32)], 16, _hoisted_14);
}
...
var script$52 = {
  ...
  components: {
    ...
    Button: script11,
    Portal: script12,
    FilterSlashIcon: script33,
    FilterFillIcon: script32,
    FilterIcon: script31,
    TrashIcon: script35,
    PlusIcon: script34
  },
...
var script$22 = {
  ...
  computed: {
    ...
    sortableColumnIcon: function sortableColumnIcon() {
      ...
      if (!sorted2) return script36;
      else if (sorted2 && sortOrder2 > 0) return script38;
      else if (sorted2 && sortOrder2 < 0) return script37;
      return null;
    },
  ...
  components: {
    ...
    DTHeaderCheckbox: script$42,
    DTColumnFilter: script$52,
    SortAltIcon: script36,
    SortAmountUpAltIcon: script38,
    SortAmountDownIcon: script37
  }
};
...
function _slicedToArray2(r, e) {
  return _arrayWithHoles2(r) || _iterableToArrayLimit2(r, e) || _unsupportedIterableToArray24(r, e) || _nonIterableRest2();
}
...
var script39 = {
  ...
  data: function data14() {
    return {
      ...
      d_multiSortMeta: this.multiSortMeta ? _toConsumableArray23(this.multiSortMeta) : [],
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data15 = _toConsumableArray23(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray23(this.d_multiSortMeta));
        }
      }
      var data15 = _toConsumableArray23(value);
      data15.sort(function(data1, data22) {
    ...
    addMultiSortField: function addMultiSortField(field2) {
      ...
      this.d_multiSortMeta = _toConsumableArray23(this.d_multiSortMeta);
    },
    ...
    filter: function filter2(data15) {
      var _this5 = this;
      if (!data15) {
        return;
      }
      ...
      for (var i = 0; i < data15.length; i++) {
            ...
            if (filterMeta.operator) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                  ...
                  localMatch = this.executeLocalFilter(filterField, data15[i], filterConstraint2);
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](p(data15[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray23(_selection2), [rowData]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray23(this.selection), [rowData]) : [rowData];
    ...
    onSpaceKey: function onSpaceKey2(event, rowData, rowIndex2, slotProps) {
      ...
      if (event.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = h(this.selection[0], data15);
          lastSelectedRowIndex = h(this.selection[this.selection.length - 1], data15);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = h(this.selection, data15);
        }
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray23(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray23(_selection5), [rowData]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked2) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray23(this.frozenValue), _toConsumableArray23(this.processedData)) : this.processedData;
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            this.d_selectionKeys[String(p(data15, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this.d_editingRowKeys[String(p(data15, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    generateCSV: function generateCSV(options2, data15) {
      var _this6 = this;
      var csv = "\uFEFF";
      if (!data15) {
        data15 = this.processedData;
        if (options2 && options2.selectionOnly) data15 = this.selection || [];
        else if (this.frozenValue) data15 = data15 ? [].concat(_toConsumableArray23(this.frozenValue), _toConsumableArray23(data15)) : this.frozenValue;
      }
    ...
    exportCSV: function exportCSV$1(options2, data15) {
      var csv = this.generateCSV(options2, data15);
    ...
    resizeTableCells: function resizeTableCells(newColumnWidth, nextColumnWidth) {
      ...
      widths.forEach(function(width, index) {
        ...
        var style6 = "width: ".concat(colWidth, "px !important; max-width: ").concat(colWidth, "px !important");
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(e) {
      ...
      if (this.draggedColumnElement) {
        ...
        if (allowDrop) {
          ...
          var reorderedWidths = [].concat(_toConsumableArray23(remainingItems.slice(0, dropColIndex)), [movedItem], _toConsumableArray23(remainingItems.slice(dropColIndex)));
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray23(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray23(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event = e.originalEvent;
      var data15 = e.data;
      var groupFieldValue = p(data15, this.groupRowsBy);
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray23(this.expandedRowGroups) : [];
    ...
    addColumnWidthStyles: function addColumnWidthStyles(widths) {
      ...
      var selector = '[data-pc-name="datatable"]['.concat(this.$attrSelector, '] > [data-pc-section="tablecontainer"] ').concat(this.virtualScrollerDisabled ? "" : '> [data-pc-name="virtualscroller"]', ' > table[data-pc-section="table"]');
      widths.forEach(function(width, index) {
        var style6 = "width: ".concat(width, "px !important; max-width: ").concat(width, "px !important");
        innerHTML += "\n        ".concat(selector, ' > thead[data-pc-section="thead"] > tr > th:nth-child(').concat(index + 1, "),\n        ").concat(selector, ' > tbody[data-pc-section="tbody"] > tr > td:nth-child(').concat(index + 1, "),\n        ").concat(selector, ' > tfoot[data-pc-section="tfoot"] > tr > td:nth-child(').concat(index + 1, ") {\n            ").concat(style6, "\n        }\n    ");
      });
      this.styleElement.innerHTML = innerHTML;
    },
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray23(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray23(this.editingRows);
    ...
    onEditingMetaChange: function onEditingMetaChange2(event) {
      var data15 = event.data, field2 = event.field, index = event.index, editing2 = event.editing;
      var editingMeta = _objectSpread$1({}, this.d_editingMeta);
      var meta = editingMeta[index];
      if (editing2) {
        !meta && (meta = editingMeta[index] = {
          data: _objectSpread$1({}, data15),
          fields: []
        });
    ...
    hasSpacerStyle: function hasSpacerStyle(style6) {
      return s2(style6);
    }
  },
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray23(cols.filter(function(item) {
    ...
    processedData: function processedData() {
      ...
      if (!this.lazy && !((_this$virtualScroller = this.virtualScrollerOptions) !== null && _this$virtualScroller !== void 0 && _this$virtualScroller.lazy)) {
        if (data15 && data15.length) {
          ...
          if (this.sorted) {
            if (this.sortMode === "single") data15 = this.sortSingle(data15);
            else if (this.sortMode === "multiple") data15 = this.sortMultiple(data15);
          }
        }
      }
      return data15;
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray23(this.frozenValue), _toConsumableArray23(this.processedData)) : this.processedData;
        return s2(val) && this.selection && Array.isArray(this.selection) && val.every(function(v2) {
  ...
  components: {
    ...
    DTTableHeader: script$15,
    DTTableBody: script$82,
    DTTableFooter: script$62,
    DTVirtualScroller: script21,
...
function render25(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    content: withCtx(function(slotProps) {
      ...
      }, _objectSpread3(_objectSpread3({}, _ctx.tableProps), _ctx.ptm("table"))), [_ctx.showHeaders ? (openBlock(), createBlock(_component_DTTableHeader, {
        key: 0,
    ...
    _: 1
  }, 16, ["items", "columns", "style", "scrollHeight", "disabled", "pt"])], 16, _hoisted_23), $options.paginatorBottom ? (openBlock(), createBlock(_component_DTPaginator, {
    key: 3,
    rows: $data.d_rows,
    first: $data.d_first,
    totalRecords: $options.totalRecordsLength,
  ...
  }, _ctx.ptm("rowReorderIndicatorDown")), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.rowreorderindicatordownicon || _ctx.$slots.reorderindicatordownicon || "ArrowUpIcon")))], 16)) : createCommentVNode("", true)], 16, _hoisted_15);
}
script39.render = render25;
export {
  script39 as default
};
