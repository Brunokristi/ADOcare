  ...
  <div class="flex flex-col items-center justify-center gap-6">
    <div v-if="isFinalScreen" class="w-full flex flex-col items-center justify-center gap-3">
      <div class="w-full flex flex-col items-center justify-center py-10">
        <div class="text-heading-accent! mb-1" :class="{
          'text-success': finalSeverity === 'success',
          'text-danger': finalSeverity === 'error'
        }">
          {{ finalTitle }}
        </div>
        <div class="text-normal" :class="{
          'text-success': finalSeverity === 'success',
          'text-danger': finalSeverity === 'error'
        }">
          {{ finalMessage }}
      ...
      <Button v-if="isFinalScreen" label="Dokumenty pacienta" text @click="openPatientDocuments(props.patientId)"
