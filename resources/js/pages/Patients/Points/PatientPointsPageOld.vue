    ...
    <div class="flex flex-col gap-6 overflow-y-auto">
            ...
            <section class="bg-tag3 p-6 rounded-md flex flex-col gap-4">
                <div class="grid grid-cols-15 gap-4">
                    ...
                    <div class="col-span-12 md:col-span-3">
                        ...
                        <DatePicker ref="multiDatePickerRef" v-model="dates" selectionMode="multiple"
                            dateFormat="dd.mm.yy" :showIcon="false" showButtonBar class="w-full" :manualInput="false"
                            :viewDate="viewDate" :maxDate="maxSelectableDate"
        ...
        <Dialog v-model:visible="pointDialog" :style="{ width: '600px' }" header="Upraviť záznam" :modal="true">
            <div v-if="editPoint" class="flex flex-col gap-6">
                ...
                <div>
                    <label class="block text-normal mb-1">Diagnóza</label>
                    <AutoComplete v-model="editPoint.diagnosis" :suggestions="filteredDiagnoses"
                        @complete="searchDiagnoses" :virtualScrollerOptions="{ itemSize: 38 }" optionLabel="code"
                        dropdown dropdownMode="blank" :minLength="0" completeOnFocus class="w-full"
                        inputClass="!w-full !shadow-none !bg-white focus:!ring-0 focus:!shadow-none">
                        <template #option="slotProps">
                ...
                <div>
                    <label class="block text-normal mb-1">Výkon</label>
                    <AutoComplete v-model="editPoint.procedure" :suggestions="filteredProcedures"
                        @complete="searchProcedures" :virtualScrollerOptions="{ itemSize: 38 }" optionLabel="code"
                        dropdown dropdownMode="blank" :minLength="0" completeOnFocus class="w-full"
                        inputClass="!w-full !shadow-none !bg-white focus:!ring-0 focus:!shadow-none">
                        <template #option="slotProps">
                            <span>{{ slotProps.option.code }} – {{ slotProps.option.description }}</span>
