...
const { previewUrl, downloadOptions } = usePublicDocument(props, {
    privatePreviewUrl: `/v1/invoices/${route.params.documentId}/preview`,
    privateDownloadUrl: `/api/v1/invoices/${route.params.documentId}/download`
})
</script>

<template>
    <DocumentShell title="Faktúra" :previewUrl="previewUrl" :downloadOptions="downloadOptions"
