...
const props = defineProps<{ modelValue: string | null; resolveTrigger?: number | null }>()
...
<template>
  <AutoComplete v-model="query" :suggestions="suggestions" optionLabel="label" @complete="onComplete" @item-select="onSelect" @input="onInput" class="w-full" />
</template>
