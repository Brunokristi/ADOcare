...
<template>
    ...
    <div class="h-full flex flex-col overflow-hidden min-h-0">
        <Toolbar class="flex-none !bg-transparent !border-0 !p-0 !py-3 !shadow-none flex items-center justify-between">
            <template #end>
        ...
        <div class="flex-1 overflow-hidden min-h-0">
            <DataTable ref="dt" :value="rows" dataKey="id" :loading="loading" stripedRows removableSort lazy paginator
                :first="first" :rows="perPage" :totalRecords="totalRecords" @page="onPage" sortMode="single"
                @sort="onSort" scrollable scrollHeight="flex" class="h-full">
