...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Database-only backups: keep source files empty.
                ],
        ...
        'destination' => [
            ...
            'disks' => [
                ...array_filter([
                    env('BACKUP_LOCAL_DISK', 'local'),
                    env('BACKUP_CLOUD_DISK', ''),
                ]),
            ],
         ...
         */
        'encryption' => env('BACKUP_ARCHIVE_PASSWORD') ? env('BACKUP_ARCHIVE_ENCRYPTION', 'default') : 'none',
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                MaximumAgeInDays::class => (int) env('BACKUP_HEALTH_MAX_AGE_DAYS', 2),
                MaximumStorageInMegabytes::class => (int) env('BACKUP_HEALTH_MAX_STORAGE_MB', 10000),
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_weekly_backups_for_weeks' => (int) env('BACKUP_KEEP_WEEKLY_WEEKS', 12),

            /*
             * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
             * of that month will be kept. Older backups within the same month will be removed.
             */
            'keep_monthly_backups_for_months' => (int) env('BACKUP_KEEP_MONTHLY_MONTHS', 24),

            /*
             * After the "keep_monthly_backups_for_months" period is over, the most recent backup
             * of that year will be kept. Older backups within the same year will be removed.
             */
            'keep_yearly_backups_for_years' => (int) env('BACKUP_KEEP_YEARLY_YEARS', 5),
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => (int) env('BACKUP_MAX_STORAGE_MB', 10000),
        ],
